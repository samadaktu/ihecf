          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Link to={`/student-registration?subject=${encodeURIComponent("IHECF Ethiopia Student Pre-Registration")}`} className="btn-secondary px-8 py-4 text-sm md:text-base flex items-center gap-2">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
              ...
              <div className="relative z-10" id="rsvp-form">
                ...
                <Link 
                  to={`/student-registration?subject=${encodeURIComponent("IHECF Ethiopia Student Pre-Registration")}`}
