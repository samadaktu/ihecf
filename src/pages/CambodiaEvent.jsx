...
import { MapPin, Users, Globe, ArrowLeft, ArrowRight, Calendar, CheckCircle, Target, Sparkles, Building2, Medal, Briefcase, Clock, FileText, Settings, Award } from 'lucide-react';
import SEO from '../components/SEO';

const CambodiaEvent = () => {
  const highlights = [
    "High-Impact Recruitment Platform in Southeast Asia connecting Indian universities with motivated Cambodian students",
    "Promote all three location options (India, Dubai, and Malaysia) under one brand identity",
    "Direct face-to-face interaction and counseling with prospective undergraduate and postgraduate candidates and parents",
    "Establish MOU collaborations and strategic partnerships with Cambodian schools, universities, and education agencies",
  ...
  const whyParticipate = [
    { title: "Access High-Quality Students", desc: "Meet academically strong Cambodian students actively seeking affordable, globally recognized education in IT, engineering, business, hospitality, agriculture, and health sciences.", icon: <Users /> },
    ...
    { title: "Build Long-Term Partnerships", desc: "Connect with Cambodian schools, colleges, and education agencies to explore dual degrees, joint research, and faculty exchange.", icon: <Building2 /> },
    { title: "Boost Brand Visibility", desc: "Gain massive exposure via Edunial Group's extensive media partnerships, social media networks, and localized outreach in Phnom Penh.", icon: <Sparkles /> },
  ...
  const coreBenefits = [
    { title: "Premium Exhibition Space", desc: "Branded booth in Cambodia with space for banners, brochures, digital displays, and interactive student counseling." },
    { title: "Pre-Registered Leads", desc: "Direct access to profiles of students pre-registered by interest areas (engineering, IT, management, etc.)." },
    ...
    { title: "Speaking Opportunities", desc: "Participate in expert panels on ASEAN-India education partnerships or deliver short presentations." },
  ...
  const whoShouldParticipate = [
    "Indian Universities (Public & Private) looking to expand in Southeast Asia.",
  ...
  const registrationSteps = [
    { step: "Step 1", title: "Check Availability", desc: "Contact Edunial Group to confirm booth availability, official event dates, and timings for the Cambodia tour." },
    ...
    { step: "Step 4", title: "Prepare Student Plan", desc: "Decide on exclusive scholarships, fee discounts, or special offers for Cambodian students. Train your counseling team." },
    { step: "Step 5", title: "Join IHECF Cambodia", desc: "Attend the fair in Phnom Penh, engage directly with thousands of student cohorts, collect leads, and finalize admissions." }
  ];

  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="IHECF Cambodia 2026-27 | Indian Higher Education & Career Fair" 
        description="Connect with motivated Cambodian students at IHECF Cambodia. Showcase your programs in India, Dubai & Malaysia. Expand your university recruitment in Southeast Asia."
        keywords="IHECF Cambodia 2026, Indian Education Fair Phnom Penh, Study in India Fair Cambodia, Education Exhibition Cambodia, Southeast Asia Student Recruitment"
        schema={{
          "@context": "https://schema.org",
          "@type": "EducationEvent",
          "name": "IHECF Cambodia 2026-27 | Indian Higher Education & Career Fair",
          "description": "Strategic platform connecting universities and colleges with thousands of aspiring Cambodian students and parents exploring options in India, Dubai, and Malaysia.",
          "startDate": "2026-11-01T09:00:00+07:00",
          "endDate": "2026-11-30T17:00:00+07:00",
      ...
      <section className="bg-primary text-white pt-24 md:pt-32 pb-16 md:pb-24 relative overflow-hidden px-6">
        <div className="absolute inset-0 z-0">
          <img src="/cambodia_landmark.png" alt="Angkor Wat Temple Cambodia Landmark" className="w-full h-full object-cover opacity-35 scale-105" />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-secondary/20 rounded-full text-[10px] md:text-xs font-black uppercase tracking-widest text-secondary mb-6 border border-secondary/20">
                <Globe size={14} /> Southeast Asian Market | High-Intent Cohorts
              </div>
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-6 leading-tight">
                IHECF <span className="text-secondary italic">Cambodia 2026-27</span>
                <span className="block text-2xl sm:text-3xl md:text-4xl text-secondary font-black uppercase tracking-widest mt-3">Phnom Penh Edition</span>
              </h1>
              <p className="text-lg md:text-2xl text-gray-300 font-bold mb-4">Empowering Cambodia’s Students with Global Education Opportunities in India, Dubai & Malaysia</p>
              <p className="text-base md:text-xl text-gray-400 leading-relaxed max-w-3xl mb-8">
                Edunial Group presents IHECF Cambodia 2026-27, a premium recruitment initiative helping Indian universities, colleges, and campuses in Dubai and Malaysia connect directly with thousands of qualified, career-driven students in the region.
              </p>
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-[2rem] w-full md:w-80 shadow-2xl">
               ...
               <div className="space-y-6">
                   ...
                   <div className="flex items-center gap-4 group">
                      ...
                      <div>
                          <div className="text-lg font-black text-white">Phnom Penh</div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-6 text-primary">About the <span className="text-secondary italic">Cambodia Fair</span></h2>
            <div className="w-20 h-1 bg-secondary mb-8"></div>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              IHECF-2026-27 (Cambodia) is organized by Edunial Group to serve as a strategic bridge for educational institutions looking to recruit high-intent, qualified students from Southeast Asia.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              With a strong demand in Cambodia for quality programs in Engineering, IT, Management, Agriculture, and Health Sciences, the event offers a direct face-to-face platform to engage with prospective undergraduate and postgraduate candidates, discuss scholarships, evaluate credentials on-spot, and build sustainable enrollment channels in this expanding market.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-[2rem] p-8 border border-gray-100 hover:shadow-xl transition-all">
               <h3 className="text-4xl font-black text-primary mb-2">3 Countries</h3>
               <p className="text-gray-500 font-bold">India, Dubai & Malaysia Study Paths</p>
            </div>
            <div className="bg-secondary/10 rounded-[2rem] p-8 border border-secondary/20 hover:shadow-xl transition-all">
               <h3 className="text-4xl font-black text-secondary mb-2">High-Intent</h3>
               <p className="text-gray-700 font-bold">Student Cohorts</p>
            </div>
      ...
      <section className="py-16 bg-gray-50 px-6 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-primary mb-4">Why Participate in IHECF <span className="text-secondary">Cambodia?</span></h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Key opportunities and institutional rewards designed to maximize your recruitment yields in Southeast Asia.</p>
          </div>
      ...
      {/* Registration Timeline / Step-by-Step */}
      <section className="py-16 md:py-24 bg-gray-50 px-6 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Five simple steps to secure your institution's participation at IHECF Cambodia.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-8 bg-gray-50 p-6 rounded-[2rem] border border-gray-100 shadow-inner">
              <h3 className="text-lg font-bold text-primary mb-3">Expand to Cambodia & Southeast Asia</h3>
              <p className="text-gray-500 text-sm leading-relaxed">
                Connect with highly qualified Cambodian student populations ready to study in India, Dubai, and Malaysia. Align your recruitment plans with Edunial Group's strategic tour to maximize enrollment conversions.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-500 mb-8 text-sm">Join prestigious institutions at the Southeast Asia edition. Booths are allocated on a first-come, first-served basis.</p>
                ...
                <Link to="/university-registration?subject=IHECF Cambodia University Registration" className="btn-secondary w-full py-4 text-base flex justify-center items-center gap-2 font-bold shadow-lg shadow-secondary/10">
      ...
      <div className="bg-primary py-8 text-center text-white/40 text-[10px] uppercase tracking-widest px-6 border-t border-white/10">
         IHECF Cambodia 2026-27 | Indian Education Fair Phnom Penh | Study in India, Dubai & Malaysia Recruitment Fair Cambodia | Organized by Edunial Group<br/>
         Connecting Southeast Asian Aspirants with Renowned Global Universities
      </div>
    </div>
  );
};

export default CambodiaEvent;
