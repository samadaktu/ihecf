...
import { MapPin, Users, Globe, ArrowLeft, ArrowRight, Calendar, CheckCircle, GraduationCap, Sparkles, Clock, BookOpen, Building2 } from 'lucide-react';
import SEO from '../components/SEO';

const KuwaitStudent = () => {
  const studyInIndiaReasons = [
    { title: "World-Class Programs", desc: "Access high-quality degrees in Engineering, Medicine, Management, IT, Sciences, Humanities, and Design leading to global careers." },
    { title: "Exceptional Value & Affordability", desc: "Tuition fees and living costs in India are significantly lower than in the US, UK, Canada, or Australia, while maintaining high academic standards." },
    ...
    { title: "Strong Industry Connections", desc: "Deep partnerships with top industries offering internships and excellent global placement opportunities." },
    { title: "Globally Valued Degrees", desc: "Indian degrees are increasingly recognized and valued by employers in Kuwait, the GCC, Africa, Europe, and beyond." },
    { title: "Safe & Welcoming Environment", desc: "Dedicated international student support services, secure campus accommodation, and smooth cultural integration." }
  ];

  const studyInDubaiMalaysiaReasons = [
    { title: "Indian Curricula in Global Hubs", desc: "Study Indian university curricula closer to home at international campuses in Dubai and Malaysia." },
    { title: "International Exposure", desc: "Gain massive exposure in major GCC and Southeast Asian business hubs with lower costs than Western countries." },
    { title: "Strategic Career Markets", desc: "Access strong career pathways in business, technology, engineering, healthcare, logistics, and tourism." },
    { title: "Comfort & Travel Convenience", desc: "Very short travel distances from Kuwait, strong GCC business networks, and cultural and religious familiarity." }
  ];

  const whatYouGain = [
    { title: "Direct Interaction", desc: "Meet university delegates and representatives face-to-face in Kuwait to discuss admissions, fees, and campus life." },
    ...
    { title: "Scholarship & Aid Guidance", desc: "Discover government, merit-based, and need-based scholarship options available for GCC and international students." },
    { title: "Clear Pathway Maps", desc: "Understand entrance exams, application timelines, document requirements, and visa processing steps." }
  ];
  ...
  const universityBenefits = [
    "Recruit high-intent students from Kuwait City and across Kuwait.",
    ...
    "Expand institutional brand authority and visibility in the high-potential GCC market."
  ];

  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="Student Guide: IHECF Kuwait 2026-27 | Study in India Dubai Malaysia" 
        description="Discover global higher education options in India, Dubai & Malaysia. Meet top universities in Kuwait. Pre-register for free admissions counseling & scholarships."
        keywords="Study in India Kuwait, IHECF Kuwait Student Fair, Education Fair Kuwait City, Indian Universities Kuwait"
        schema={{
          "@context": "https://schema.org",
          "@type": "EducationEvent",
          "name": "Student Guide: IHECF Kuwait 2026-27 | Study in India Dubai Malaysia",
          "description": "Gateway to world-class education in India, Dubai, and Malaysia for students and families from Kuwait. Free pre-registration.",
          ...
          "offers": {
            "@type": "Offer",
            "url": "https://ihecf.info/student/kuwait",
            "price": "0",
            "priceCurrency": "KWD",
      ...
      <section className="bg-primary text-white pt-24 md:pt-32 pb-16 md:pb-24 relative overflow-hidden px-6">
        <div className="absolute inset-0 z-0">
          <img src="/kuwait_education_fair.png" alt="Kuwait City Skyline Landmark" className="w-full h-full object-cover opacity-35 scale-105" />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-6 leading-tight">
                Kuwait <span className="text-secondary italic">Edition 2026-27</span>
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-[2rem] w-full md:w-80 shadow-2xl">
               ...
               <div className="space-y-6">
                   ...
                   <div className="flex items-center gap-4 group">
                       ...
                       <div>
                           <div className="text-lg font-black text-white">Kuwait City</div>
                           <div className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Kuwait Venue</div>
                       </div>
                   </div>
                   <div className="flex items-center gap-4 group">
                       <div className="w-12 h-12 bg-white/10 text-secondary rounded-xl flex items-center justify-center group-hover:bg-secondary group-hover:text-white transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Choosing the right university is a life-defining choice. The Indian Higher Education & Career Fair (IHECF), organized by Edunial Group, brings premier universities from India, Dubai, and Malaysia directly to you in Kuwait.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
            ...
            <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-secondary mt-4">
              <p className="text-sm text-gray-500 italic">
                "Are you a representative from a higher education institution? Visit our dedicated <Link to="/country/kuwait" className="text-secondary font-bold underline">University Exhibitor Page</Link> for registrations."
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-primary mb-6">Recruit from <span className="text-secondary">Kuwait</span></h2>
            <div className="space-y-4">
      ...
      <div className="bg-primary py-8 text-center text-white/40 text-[10px] uppercase tracking-widest px-6 border-t border-white/10">
         IHECF Kuwait 2026-27 Student Portal | Study in India, Dubai & Malaysia Fair | Education Fair Kuwait City | GCC Student Admissions<br/>
         Connecting Kuwaiti Students and Families with Top Universities | Powered by Edunial Group
      </div>
    </div>
  );
};

export default KuwaitStudent;
