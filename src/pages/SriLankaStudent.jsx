          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
              ...
              <div className="relative z-10" id="rsvp-form">
                ...
                <p className="text-gray-500 mb-8 text-sm">Secure your entry pass to Sri Lanka's most anticipated higher education fair and explore pathways in India, Dubai, and Malaysia.</p>
