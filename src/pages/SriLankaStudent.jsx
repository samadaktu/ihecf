...
const SriLankaStudent = () => {
  const studyInIndiaReasons = [
    { title: "World-Class Programs", desc: "Access high-quality degrees in Engineering, Medicine, Management, IT, Commerce, Sciences, and Design leading to global careers." },
    { title: "High-Value Affordability", desc: "Tuition fees and living costs in India are far lower than in the US, UK, Canada, or Australia, while maintaining high academic quality." },
    ...
    { title: "Degrees Recognised Worldwide", desc: "Indian degrees are increasingly valued by employers in Sri Lanka, the GCC, Southeast Asia, Europe, and beyond." },
    { title: "Cultural & Geographic Familiarity", desc: "Close historical and cultural ties with Sri Lanka. Similar food, festivals, short travel times, and active student communities." }
  ];
  ...
  const studyInDubaiMalaysiaReasons = [
    ...
    { title: "Strong Career Markets", desc: "Access robust job and internship markets in technology, finance, business, logistics, and tourism in the GCC (Dubai) and Southeast Asia (Malaysia)." },
    { title: "Convenient Student Hubs", desc: "Familiar professional communities, abundant internship pathways, and convenient travel options." }
  ];

  const whatYouGain = [
    { title: "Direct Interaction", desc: "Meet university delegates face-to-face in Colombo and Kandy to discuss courses, fees, entry requirements, and scholarships." },
    ...
    { title: "Scholarship Guidance", desc: "Discover institutional merit-based scholarships and financial aid options for Sri Lankan students." },
  ...
  const universityBenefits = [
    "Recruit high-intent students from Colombo, Kandy, Galle, and across Sri Lanka.",
    "Promote flagship programs and scholarships directly to motivated applicants and parents.",
    "Build long-term collaborations with schools, educational counselors, and local agencies.",
    "Expand institutional brand authority in the high-potential South Asian market."
  ];

  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="Student Guide: IHECF Sri Lanka 2026-27 | Study in India Dubai Malaysia" 
        description="Discover global higher education options in India, Dubai & Malaysia. Meet top universities in Colombo and Kandy. Pre-register for free admissions counseling & scholarships."
        keywords="Study in India Sri Lanka, IHECF Sri Lanka Student Fair, Education Fair Colombo, Kandy Education Exhibition, Indian Universities Sri Lanka"
        schema={{
          "@context": "https://schema.org",
          "@type": "EducationEvent",
          "name": "Student Guide: IHECF Sri Lanka 2026-27 | Study in India Dubai Malaysia",
          "description": "Gateway to world-class education in India, Dubai, and Malaysia for students and families from Sri Lanka. Free pre-registration.",
          ...
          "offers": {
            "@type": "Offer",
            "url": "https://ihecf.info/student/sri-lanka",
            "price": "0",
            "priceCurrency": "LKR",
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-6 leading-tight">
                Sri Lanka <span className="text-secondary italic">Edition 2026-27</span>
                <span className="block text-2xl sm:text-3xl md:text-4xl text-secondary font-black uppercase tracking-widest mt-3">Colombo & Kandy Fair</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Link to={`/student-registration?subject=${encodeURIComponent("IHECF Sri Lanka Student Pre-Registration")}`} className="btn-secondary px-8 py-4 text-sm md:text-base flex items-center gap-2">
               ...
               <div className="space-y-6">
                   ...
                   <div className="flex items-center gap-4 group">
                      ...
                      <div>
                          ...
                          <div className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Sri Lanka Hubs</div>
                      </div>
                   </div>
                   <div className="flex items-center gap-4 group">
                      <div className="w-12 h-12 bg-white/10 text-secondary rounded-xl flex items-center justify-center group-hover:bg-secondary group-hover:text-white transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Choosing the right university is a life-defining choice. The Indian Higher Education & Career Fair (IHECF), organized by Edunial Group, brings premier universities from India, Dubai, and Malaysia to Colombo and Kandy.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
            ...
            <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-secondary mt-4">
              <p className="text-sm text-gray-500 italic">
                "Are you a representative from a higher education institution? Visit our dedicated <Link to="/country/sri-lanka" className="text-secondary font-bold underline">University Exhibitor Page</Link> for registrations."
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-secondary/10 rounded-[2rem] p-8 border border-secondary/20 hover:shadow-xl transition-all">
               <h3 className="text-4xl font-black text-secondary mb-2">2 Hubs</h3>
               <p className="text-gray-700 font-bold">Colombo & Kandy Events</p>
            </div>
      ...
      <section className="py-16 bg-gray-50 px-6 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Discover why India is a preferred higher education destination for Sri Lankan students.</p>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">Gain international exposure at global academic hubs in the GCC and Southeast Asia.</p>
        </div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-primary mb-6">Recruit from <span className="text-secondary">Sri Lanka</span></h2>
            <div className="space-y-4">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
              ...
              <div className="relative z-10" id="rsvp-form">
                ...
                <Link 
                  to={`/student-registration?subject=${encodeURIComponent("IHECF Sri Lanka Student Pre-Registration")}`}
      ...
      <div className="bg-primary py-8 text-center text-white/40 text-[10px] uppercase tracking-widest px-6 border-t border-white/10">
         IHECF Sri Lanka 2026-27 Student Portal | Study in India, Dubai & Malaysia Fair | Education Fair Colombo Kandy | South Asian Student Admissions<br/>
         Connecting Sri Lankan Students and Families with Top Universities | Powered by Edunial Group
      </div>
    </div>
  );
};

export default SriLankaStudent;
