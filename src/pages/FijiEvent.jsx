...
const FijiEvent = () => {
  const highlights = [
    "High-Impact Recruitment Platform in the Pacific region connecting Indian universities with motivated students from Fiji and neighbouring islands",
    "Promote all three location options (India, Dubai, and Malaysia) under one brand identity",
    "Direct face-to-face interaction and counseling with prospective undergraduate and postgraduate candidates and parents in Fiji",
    "Establish MOU collaborations and strategic partnerships with Fiji schools, colleges, and education agencies",
  ...
  const whyParticipate = [
    { title: "Access High-Quality Students", desc: "Meet academically strong students from Fiji actively seeking affordable, globally recognized education in science, engineering, medicine, commerce, IT, hospitality, and environmental studies.", icon: <Users /> },
    ...
    { title: "Build Long-Term Partnerships", desc: "Connect with Fiji schools, colleges, and education agencies to explore dual degrees, joint research, and faculty exchanges.", icon: <Building2 /> },
    { title: "Boost Brand Visibility", desc: "Gain massive exposure via Edunial Group's media partnerships, social media, and localized outreach in Suva and the Pacific region.", icon: <Sparkles /> },
  ...
  const coreBenefits = [
    { title: "Premium Exhibition Space", desc: "Branded booth in Fiji with space for banners, brochures, digital displays, and interactive student counseling." },
    { title: "Pre-Registered Leads", desc: "Direct access to profiles of students pre-registered by interest areas (engineering, medicine, management, hospitality, etc.)." },
    ...
    { title: "Speaking Opportunities", desc: "Participate in expert panels on global education trends or deliver short presentations." },
  ...
  const whoShouldParticipate = [
    "Indian Universities (Public & Private) looking to expand in the Pacific region.",
  ...
  const registrationSteps = [
    { step: "Step 1", title: "Check Availability", desc: "Contact Edunial Group to confirm booth availability, official event dates, and timings for the Fiji tour." },
    ...
    { step: "Step 4", title: "Prepare Student Plan", desc: "Decide on exclusive scholarships, fee discounts, or special offers for Fiji and Pacific students. Train your counseling team." },
    { step: "Step 5", title: "Join IHECF Fiji", desc: "Attend the fair in Suva, engage directly with thousands of student cohorts, collect leads, and finalize admissions." }
  ];

  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="IHECF Fiji 2026-27 | Indian Higher Education & Career Fair" 
        description="Connect with motivated students and parents in Fiji at IHECF Fiji. Showcase your programs in India, Dubai & Malaysia. Expand your university recruitment in the Pacific."
        keywords="IHECF Fiji 2026, Indian Education Fair Suva, Study in India Fair Fiji, Education Exhibition Fiji, Pacific Student Recruitment"
        schema={{
          "@context": "https://schema.org",
          "@type": "EducationEvent",
          "name": "IHECF Fiji 2026-27 | Indian Higher Education & Career Fair",
          "description": "Strategic platform connecting universities and colleges with thousands of aspiring student cohorts from Fiji and the Pacific exploring options in India, Dubai, and Malaysia.",
          "startDate": "2026-11-01T09:00:00+12:00",
          "endDate": "2026-11-30T17:00:00+12:00",
      ...
      <section className="bg-primary text-white pt-24 md:pt-32 pb-16 md:pb-24 relative overflow-hidden px-6">
        <div className="absolute inset-0 z-0">
          <img src="/fiji_landmark.png" alt="Tropical Beach Fiji Landmark" className="w-full h-full object-cover opacity-35 scale-105" />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-secondary/20 rounded-full text-[10px] md:text-xs font-black uppercase tracking-widest text-secondary mb-6 border border-secondary/20">
                <Globe size={14} /> Pacific Market | Gateway to Oceania
              </div>
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-6 leading-tight">
                IHECF <span className="text-secondary italic">Fiji 2026-27</span>
                <span className="block text-2xl sm:text-3xl md:text-4xl text-secondary font-black uppercase tracking-widest mt-3">Suva Edition</span>
              </h1>
              <p className="text-lg md:text-2xl text-gray-300 font-bold mb-4">Empowering Fiji’s Students with Global Education Opportunities in India, Dubai & Malaysia</p>
              <p className="text-base md:text-xl text-gray-400 leading-relaxed max-w-3xl mb-8">
                Edunial Group presents IHECF Fiji 2026-27, a premium recruitment initiative helping Indian universities, colleges, and campuses in Dubai and Malaysia connect directly with thousands of qualified, career-driven students in Fiji and the Pacific.
              </p>
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-[2rem] w-full md:w-80 shadow-2xl">
               ...
               <div className="space-y-6">
                   ...
                   <div className="flex items-center gap-4 group">
                      ...
                      <div>
                          <div className="text-lg font-black text-white">Suva, Fiji</div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-6 text-primary">About the <span className="text-secondary italic">Fiji Fair</span></h2>
            <div className="w-20 h-1 bg-secondary mb-8"></div>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              IHECF-2026-27 (Fiji) is organized by Edunial Group to serve as a strategic platform to expand your institutional footprint in the Pacific region and recruit motivated student cohorts from Fiji and neighbouring islands.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              With growing demand for affordable, high-quality, and globally recognized education in Engineering, Medicine, Commerce, IT, Hospitality, and Environmental Studies, Fiji serves as a highly receptive student corridor. Presenting your programs under the Edunial Group brand offers a comprehensive recruitment approach.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-[2rem] p-8 border border-gray-100 hover:shadow-xl transition-all">
               <h3 className="text-4xl font-black text-primary mb-2">Suva</h3>
               <p className="text-gray-500 font-bold">& surrounding coverage</p>
            </div>
            <div className="bg-secondary/10 rounded-[2rem] p-8 border border-secondary/20 hover:shadow-xl transition-all">
               <h3 className="text-4xl font-black text-secondary mb-2">Oceania</h3>
               <p className="text-gray-700 font-bold">Strategic Presence</p>
            </div>
      ...
      <section className="py-16 bg-gray-50 px-6 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-primary mb-4">Why Participate in IHECF <span className="text-secondary">Fiji?</span></h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Key opportunities and institutional rewards designed to maximize your recruitment yields in Fiji and the Pacific region.</p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50 px-6 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Five simple steps to secure your institution's participation at IHECF Fiji.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-8 bg-gray-50 p-6 rounded-[2rem] border border-gray-100 shadow-inner">
              <h3 className="text-lg font-bold text-primary mb-3">Partner with Edunial Group in Fiji</h3>
              <p className="text-gray-500 text-sm leading-relaxed">
                Connect with thousands of future global graduates from Fiji and the Pacific. Join IHECF-2026-27 and make Fiji your next successful recruitment market.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-500 mb-8 text-sm">Join prestigious institutions at the Fiji edition. Booths are allocated on a first-come, first-served basis.</p>
                ...
                <div className="bg-gray-50 rounded-2xl p-6 text-left mb-8 border border-gray-100">
                  ...
                  <p className="text-xs text-gray-650"><strong className="text-primary">Web:</strong> www.ihecf.info</p>
                </div>

                <Link to="/university-registration?subject=IHECF Fiji University Registration" className="btn-secondary w-full py-4 text-base flex justify-center items-center gap-2 font-bold shadow-lg shadow-secondary/10">
      ...
      <div className="bg-primary py-8 text-center text-white/40 text-[10px] uppercase tracking-widest px-6 border-t border-white/10">
         IHECF Fiji 2026-27 | Indian Education Fair Suva | Study in India, Dubai & Malaysia Recruitment Fair Fiji | Organized by Edunial Group<br/>
         Connecting Fiji and Pacific Island Students with Renowned Global Universities
      </div>
    </div>
  );
};

export default FijiEvent;
