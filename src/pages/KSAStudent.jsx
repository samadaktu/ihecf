          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Link to={`/student-registration?subject=${encodeURIComponent("IHECF KSA Student Pre-Registration")}`} className="btn-secondary px-8 py-4 text-sm md:text-base flex items-center gap-2">
             ...
             {eventSchedule.map((sched, idx) => (
               <div key={idx} className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-50">
                     <Link to={`/student-registration?subject=${encodeURIComponent("IHECF KSA Student Pre-Registration")}`} className="text-secondary font-bold text-xs uppercase tracking-widest flex items-center gap-1 hover:gap-2 transition-all">
                  Pre-Register for {sched.city}
                </Link>
                  </div>
               </div>
             ))}
          ...
          <div className="p-8 md:p-12 bg-gray-50 rounded-[3rem] border border-gray-100">
            ...
            <div className="space-y-4">
              {trustFactors.map((factor, index) => (
                ...
                <Link 
                  to={`/student-registration?subject=${encodeURIComponent("IHECF KSA Student Pre-Registration")}`}
