...
const ZambiaEvent = () => {
  const highlights = [
    "Focused and quality audience of students, parents & counselors in Lusaka",
    "High interest in Medicine (MBBS), Engineering, Business & Management, Information Technology, Pharmacy, Data Science, AI, Agriculture, and Allied Health Sciences",
    "Direct face-to-face interaction and counseling with prospective applicants",
    "Networking with school principals, career counselors, and Southern African education agents",
    "Immediate recruitment results with spot offers, counseling, and scholarship awards",
    "Flawless execution, premium booth setup, and targeted pre-event marketing campaign"
  ];

  const whyParticipate = [
    { title: "High-Potential Audience", desc: "Connect directly with motivated Zambian students and parents with strong interest in MBBS, Tech, Management, and more.", icon: <Users /> },
    { title: "Immediate Recruitment Results", desc: "Conduct personalized counseling, collect applications, issue provisional offers, and award merit-based scholarships on the spot.", icon: <Medal /> },
    { title: "Premium Brand Visibility", desc: "Position your institution among Zambia's growing middle and upper-class families and international schools.", icon: <Sparkles /> },
    { title: "Strategic Networking", desc: "Build valuable relationships with school principals, career counselors, agents, and government officials in Southern Africa.", icon: <Target /> },
    { title: "Proven Track Record", desc: "Join Edunial Groups' series of fairs that consistently delivers strong enrollment outcomes in African nations.", icon: <Briefcase /> },
    { title: "World-Class Venue & Execution", desc: "Benefit from the luxury setting of Taj Hotel, premium booth setup, and targeted pre-event promotion.", icon: <Building2 /> },
  ];
  ...
  const whoShouldParticipate = [
    ...
    "Specialized Colleges in high-demand emerging fields (AI, Cybersecurity, Hospitality, Design, etc.)",
    "Institutions offering attractive scholarships and dedicated support for African international students"
  ];

  const benefits = [
    "Premium & Corner Booth Options with superior visibility at the Taj Hotel, Lusaka",
    ...
    "Comprehensive Digital & Pre-Event Promotion Campaign targeting Zambian audiences",
    "Post-event access to qualified student leads and database",
    "Opportunity to build a successful, long-term partnership in Southern Africa"
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-primary text-white pt-24 md:pt-32 pb-16 md:pb-24 relative overflow-hidden px-6">
        <div className="absolute inset-0 z-0">
          <img src="/zambia_education_fair.png" alt="Zambia Event Lusaka" className="w-full h-full object-cover opacity-30 scale-105" />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-secondary/20 rounded-full text-[10px] md:text-xs font-black uppercase tracking-widest text-secondary mb-6 border border-secondary/20">
                <Globe size={14} /> Southern African Market | High Potential
              </div>
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-6 leading-tight">
                IHECF <span className="text-secondary italic">Zambia 2026-27</span>
              </h1>
              <p className="text-lg md:text-2xl text-gray-300 font-bold mb-4">Open the Door to Zambia's Emerging Higher Education Market</p>
              <p className="text-base md:text-xl text-gray-400 leading-relaxed max-w-3xl mb-8">
                We cordially invite India’s leading universities, colleges, and premier higher education institutions to participate in a prestigious and high-impact recruitment platform in Zambia’s vibrant capital.
              </p>
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-[2rem] w-full md:w-80 shadow-2xl">
               ...
               <div className="space-y-6">
                   ...
                   <div className="flex items-center gap-4 group">
                      ...
                      <div>
                         <div className="text-lg font-black text-white">Taj Hotel, Lusaka</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              The Indian Higher Education & Career Fair (IHECF) Zambia Edition 2026-27 is a premium recruitment platform designed to connect leading Indian universities and colleges with ambitious Zambian students and their families.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              Zambia, with its rapidly growing economy, young population, and increasing demand for quality international education, presents a strategic and high-potential market for Indian institutions. Hosted at the iconic Taj Hotel in Lusaka, this exclusive event offers direct, face-to-face access to students actively seeking undergraduate and postgraduate opportunities in high-demand fields.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed mt-4">
              Organized by Edunial Groups, IHECF has established itself as one of the most respected and result-driven platforms across the African continent, delivering exceptional brand visibility and long-term enrollment success.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-[2rem] p-8 border border-gray-100 hover:shadow-xl transition-all">
               ...
               <p className="text-gray-500 font-bold">Demand & Growth</p>
            </div>
            <div className="bg-secondary/10 rounded-[2rem] p-8 border border-secondary/20 hover:shadow-xl transition-all">
               <h3 className="text-4xl font-black text-secondary mb-2">Taj Hotel</h3>
               <p className="text-gray-700 font-bold">Luxury Venue</p>
            </div>
      ...
      <section className="py-16 bg-gray-50 px-6 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-primary mb-4">Why Top Indian Institutions Choose <span className="text-secondary">Zambia</span></h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Expand your global footprint in Southern Africa and secure your student pipeline.</p>
          </div>
            ...
            <div className="lg:col-span-5">
              <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl md:text-3xl font-black text-primary mb-4 leading-tight">Ready to Recruit in the Zambian Market?</h3>
                  <p className="text-gray-500 mb-8 text-sm">Prime booths and high-visibility sponsorships are allocated on a first-come, first-served basis.</p>
                  ...
                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-4">Early Booking Advantage Open</p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-primary py-8 text-center text-white/40 text-[10px] uppercase tracking-widest px-6 border-t border-white/10">
         IHECF Zambia 2026-27 | Indian Higher Education & Career Fair Lusaka | Study in India Fair Zambia | Education Exhibition Lusaka Taj Hotel<br/>
         Connecting Zambian Students with India’s Finest Universities | Expanding Educational Horizons in Southern Africa
      </div>
    </div>
  );
};

export default ZambiaEvent;
