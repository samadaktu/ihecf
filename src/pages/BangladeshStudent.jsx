...
const BangladeshStudent = () => {
  const studyInIndiaReasons = [
    { title: "World-Class Programs", desc: "Access high-quality degrees in Engineering, Health Sciences, Management, IT, Sciences, and Design leading to global careers." },
    { title: "High-Value Affordability", desc: "Tuition fees and living costs in India are far lower than Western options while keeping academic quality very strong." },
    ...
    { title: "Global Recognition", desc: "Degrees widely recognized and valued by employers in Bangladesh, India, the GCC, Europe, and beyond." },
    { title: "Cultural & Geographic Proximity", desc: "Close historical, cultural, and geographic ties with Bangladesh, making the transition very smooth and comfortable." }
  ];
  ...
  const studyInDubaiMalaysiaReasons = [
    ...
    { title: "International Exposure", desc: "Gain massive exposure in Singapore-adjacent Malaysia and GCC core Dubai with lower costs than Western countries." },
    ...
    { title: "Convenient Student Hubs", desc: "Well-established Bangladeshi communities, abundant internship pathways, and convenient travel options." }
  ];
  ...
  const whatYouGain = [
    ...
    { title: "Scholarship Guidance", desc: "Discover institutional merit-based scholarships and government financial aid options for Bangladeshi students." },
  ...
  const universityBenefits = [
    "Recruit high-intent students from Dhaka, Chittagong, Rajshahi, and across Bangladesh.",
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="Student Guide: IHECF Bangladesh 2026-27 | Study in India Dubai Malaysia" 
        description="Discover global higher education options in India, Dubai & Malaysia. Meet top universities in Bangladesh. Pre-register for free admissions counseling & scholarships."
        keywords="Study in India Bangladesh, IHECF Bangladesh Student Fair, Education Fair Dhaka, Indian Universities Bangladesh"
        schema={{
          "@context": "https://schema.org",
          "@type": "EducationEvent",
          "name": "Student Guide: IHECF Bangladesh 2026-27 | Study in India Dubai Malaysia",
          "description": "Gateway to world-class education in India, Dubai, and Malaysia for students and families from Bangladesh. Free pre-registration.",
          ...
          "offers": {
            "@type": "Offer",
            "url": "https://ihecf.info/student/bangladesh",
            "price": "0",
            "priceCurrency": "BDT",
      ...
      <section className="bg-primary text-white pt-24 md:pt-32 pb-16 md:pb-24 relative overflow-hidden px-6">
        <div className="absolute inset-0 z-0">
          <img src="/bangladesh_landmark.png" alt="Dhaka Bangladesh Landmark" className="w-full h-full object-cover opacity-35 scale-105" />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-6 leading-tight">
                Bangladesh <span className="text-secondary italic">Edition 2026-27</span>
              ...
              <div className="flex flex-wrap gap-4">
                <Link to={`/student-registration?subject=${encodeURIComponent("IHECF Bangladesh Student Pre-Registration")}`} className="btn-secondary px-8 py-4 text-sm md:text-base flex items-center gap-2">
               ...
               <div className="space-y-6">
                   ...
                   <div className="flex items-center gap-4 group">
                      ...
                      <div>
                          ...
                          <div className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Bangladesh Hubs</div>
                      </div>
                   </div>
                   <div className="flex items-center gap-4 group">
                      <div className="w-12 h-12 bg-white/10 text-secondary rounded-xl flex items-center justify-center group-hover:bg-secondary group-hover:text-white transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Choosing the right university is a life-defining choice. The Indian Higher Education & Career Fair (IHECF), organized by Edunial Group, brings premier universities from India, Dubai, and Malaysia to Dhaka, Chittagong, and Rajshahi.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
            ...
            <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-secondary mt-4">
              <p className="text-sm text-gray-500 italic">
                "Are you a representative from a higher education institution? Visit our dedicated <Link to="/country/bangladesh" className="text-secondary font-bold underline">University Exhibitor Page</Link> for registrations."
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-secondary/10 rounded-[2rem] p-8 border border-secondary/20 hover:shadow-xl transition-all">
               <h3 className="text-4xl font-black text-secondary mb-2">3 Cities</h3>
               <p className="text-gray-700 font-bold">Dhaka, Chittagong, Rajshahi</p>
            </div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-primary mb-6">Recruit from <span className="text-secondary">Bangladesh</span></h2>
            <div className="space-y-4">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
              ...
              <div className="relative z-10" id="rsvp-form">
                ...
                <Link 
                  to={`/student-registration?subject=${encodeURIComponent("IHECF Bangladesh Student Pre-Registration")}`}
      ...
      <div className="bg-primary py-8 text-center text-white/40 text-[10px] uppercase tracking-widest px-6 border-t border-white/10">
         IHECF Bangladesh 2026-27 Student Portal | Study in India, Dubai & Malaysia Fair | Education Fair Dhaka | South Asian Student Admissions<br/>
         Connecting Bangladesh Students and Families with Top Universities | Powered by Edunial Group
      </div>
    </div>
  );
};

export default BangladeshStudent;
