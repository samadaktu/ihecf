...
const ZambiaStudent = () => {
  ...
  const studyInIndiaReasons = [
    ...
    { title: "Globally Recognized Degrees", desc: "Indian degrees are highly valued by employers in Zambia, Zimbabwe, Botswana, South Africa, the GCC, and Europe." },
    { title: "Strong Student Adaptation", desc: "A growing community of Zambian students in India makes the academic and cultural transition smooth and supportive." }
  ];
  ...
  const studyInDubaiMalaysiaReasons = [
    ...
    { title: "Diaspora & Travel Convenience", desc: "Shorter travel distances from Zambia with strong African and Indian diaspora support networks." }
  ];

  const whatYouGain = [
    { title: "Direct Interaction", desc: "Meet university representatives face-to-face in Zambia to ask about programs, fees, scholarships, and campus life." },
  ...
  const universityBenefits = [
    "Recruit high-intent students from Lusaka, Kitwe, Ndola, and across Zambia.",
    "Promote flagship programs and scholarships directly to motivated applicants and parents.",
    "Build long-term collaborations with Zambian schools, education agencies, and local counselors.",
    "Expand institutional brand authority and visibility in the Southern African market."
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    data.append('event_title', 'IHECF Zambia Fair - Student Pre-Registration');
    data.append('event_country', 'Zambia');
    data.append('_subject', 'New Student RSVP: IHECF Zambia');
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="Student Guide: IHECF Zambia 2026-27 | Study in India Dubai Malaysia" 
        description="Discover global higher education options in India, Dubai & Malaysia. Meet top universities in Zambia. Pre-register for free admissions counseling & scholarships."
        keywords="Study in India Zambia, IHECF Zambia Student Fair, Education Fair Lusaka, Indian Universities Zambia"
        schema={{
          "@context": "https://schema.org",
          "@type": "EducationEvent",
          "name": "Student Guide: IHECF Zambia 2026-27 | Study in India Dubai Malaysia",
          "description": "Gateway to world-class education in India, Dubai, and Malaysia for students and families from Zambia. Free pre-registration.",
          ...
          "offers": {
            "@type": "Offer",
            "url": "https://ihecf.info/student/zambia",
            "price": "0",
            "priceCurrency": "ZMW",
      ...
      <section className="bg-primary text-white pt-24 md:pt-32 pb-16 md:pb-24 relative overflow-hidden px-6">
        <div className="absolute inset-0 z-0">
          <img src="/zambia_education_fair.png" alt="Zambia Landmark" className="w-full h-full object-cover opacity-35 scale-105" />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 md:gap-12">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-6 leading-tight">
                Zambia <span className="text-secondary italic">Edition 2026-27</span>
              ...
              <div className="flex flex-wrap gap-4">
                <Link to={`/student-registration?subject=${encodeURIComponent("IHECF Zambia Student Pre-Registration")}`} className="btn-secondary px-8 py-4 text-sm md:text-base flex items-center gap-2">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-[2rem] w-full md:w-80 shadow-2xl">
               ...
               <div className="space-y-6">
                   ...
                   <div className="flex items-center gap-4 group">
                       ...
                       <div>
                           <div className="text-lg font-black text-white">Lusaka</div>
                           <div className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Zambia Venue</div>
                       </div>
                   </div>
                   <div className="flex items-center gap-4 group">
                       <div className="w-12 h-12 bg-white/10 text-secondary rounded-xl flex items-center justify-center group-hover:bg-secondary group-hover:text-white transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Choosing the right university is a life-defining choice. The Indian Higher Education & Career Fair (IHECF), organized by Edunial Group, brings premier universities from India, Dubai, and Malaysia directly to you in Zambia.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
            ...
            <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-secondary mt-4">
              <p className="text-sm text-gray-500 italic">
                "Are you a representative from a higher education institution? Visit our dedicated <Link to="/country/zambia" className="text-secondary font-bold underline">University Exhibitor Page</Link> for registrations."
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50 px-6 border-y border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Discover why India is now a leading global destination for Zambian students.</p>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto border-t border-gray-100 bg-gray-50/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Understand how we structure support specifically for Zambian applicants.</p>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto border-t border-gray-100">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-primary mb-6">Recruit from <span className="text-secondary">Zambia</span></h2>
            <div className="space-y-4">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
              ...
              <div className="relative z-10" id="rsvp-form">
                ...
                <Link 
                  to={`/student-registration?subject=${encodeURIComponent("IHECF Zambia Student Pre-Registration")}`}
      ...
      <div className="bg-primary py-8 text-center text-white/40 text-[10px] uppercase tracking-widest px-6 border-t border-white/10">
         IHECF Zambia 2026-27 Student Portal | Study in India, Dubai & Malaysia Fair | Education Fair Lusaka Kitwe Ndola | Southern African Student Admissions<br/>
         Connecting Zambian Students and Families with Top Universities | Powered by Edunial Group
      </div>
    </div>
  );
};

export default ZambiaStudent;
